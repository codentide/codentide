...
<span>![My Skills](https://skillicons.dev/icons?i=next,react,js,ts)</span>
<span>![My Skills](https://go-skill-icons.vercel.app/api/icons?i=zustand)</span>
<span>![My Skills](https://skillicons.dev/icons?i=html,css,sass,tailwind,vite,supabase,git)</span>
...
| :---------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Pokénex PRO** | Highly interactive, fast, and high-performance website for checking Pokémon information, calculating types, and saving your favorite Pokémon thanks to the advantages of SRR and NextJS. | NextJS, TS, Zustand | [Code](https://github.com/codentide/poke-nex) \| [Demo](https://poke-nex.vercel.app/)  |
...
| **To-do Manager** | To do's management application. With Supabase integrated for authentication and data persistence. | React, TS, Zustand | [Code](https://github.com/codentide/ts-react-todo-manager) \| [Demo](https://ts-react-todo-manager.netlify.app/)  |
